...
extern int s2n_tls13_prf_ephemeral_secret(struct s2n_connection *conn, struct s2n_blob *premaster_secret);
extern int s2n_tls13_prf_master_secret(struct s2n_connection *conn, struct s2n_blob *premaster_secret);
